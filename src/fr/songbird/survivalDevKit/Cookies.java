...
public class Cookies implements Serializable{
	...
	public boolean heIsInstalled(){
		...
		if(!directory.exists()){
			System.out.println("Le cookie n'existe pas.\n"
					+"Creation du cookie...");
			serializeCookies(new Cookies(), getPathFileSerial());
		}
		return true;
	}
	/**
	...
	public static File getPathFileSerial(){
		return Cookies.pathFileSerial;
	}
	
	public static void setPathFileSerial(File PFS){
		Cookies.pathFileSerial = PFS;
	}
	
	public static void serializeCookies(Cookies cookie, File pathFileSerial){
	...
	public static Cookies DeserializeCookies(){
		FileInputStream fileDeserial = null;
		ObjectInputStream objectDeserial = null;
		Cookies cookie = null;
		File pathFileDeserial = Cookies.getPathFileSerial();
		...
		try{
			...
			try{
				...
				try{
					cookie = (Cookies)objectDeserial.readObject();
